...
public class ZaposleniF extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ZaposleniF window = new ZaposleniF(jo);
	 ...
	 */
	public ZaposleniF(Administrator pera) {
	 this.jo = pera;
		initialize();
	}
	
	static Administrator jo;
	...
	public static boolean proveriime(String ime)
	{
		...
		{
			Administrator test = metode.aa.get(i);
			if(test.K_Ime==ime)
			{
				return false;
			}
	...
	private void initialize() {
		...
		textField_4.setText(String.valueOf(jo.plata));
		...
		textField_3.setText(jo.K_Ime);
		textField_5.setText(jo.Sifra);
	}
}
